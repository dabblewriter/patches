  ...
  it('should return state at specific revision', async () => {
    ...
    const changes = [
      ...
      },
      {
        ...
        committedAt: '2024-01-01T00:00:02.000Z',
        ops: [{ op: 'replace', path: '/count', value: 5 }],
      },
    ];
    ...
    const changes = [
      {
        ...
        createdAt: '2024-01-01T00:00:01.000Z',
        committedAt: '2024-01-01T00:00:01.000Z',
        ops: [{ op: 'add', path: '/users/0', value: { name: 'John' } }],
      },
      {
        id: 'c2',
        rev: 12,
        ...
        createdAt: '2024-01-01T00:00:02.000Z',
        committedAt: '2024-01-01T00:00:02.000Z',
        ops: [{ op: 'add', path: '/posts/0', value: { title: 'Hello' } }],
      },
    ];
    ...
    const changes = [
      {
        ...
        createdAt: '2024-01-01T00:00:01.000Z',
        committedAt: '2024-01-01T00:00:01.000Z',
        ops: [{ op: 'replace', path: '/users/0/name', value: 'John Doe' }],
      },
      {
        id: 'c2',
        rev: 22,
        ...
        createdAt: '2024-01-01T00:00:02.000Z',
        committedAt: '2024-01-01T00:00:02.000Z',
        ops: [{ op: 'add', path: '/users/1', value: { id: 2, name: 'Jane', status: 'pending' } }],
      },
      {
        id: 'c3',
        rev: 23,
        ...
        committedAt: '2024-01-01T00:00:03.000Z',
        ops: [{ op: 'replace', path: '/settings/theme', value: 'dark' }],
      },
      {
        id: 'c4',
        rev: 24,
        ...
        committedAt: '2024-01-01T00:00:04.000Z',
        ops: [{ op: 'replace', path: '/counters/posts', value: 2 }],
      },
      {
        id: 'c5',
        rev: 25,
        ...
        committedAt: '2024-01-01T00:00:05.000Z',
        ops: [{ op: 'replace', path: '/counters/views', value: 150 }],
      },
    ];
