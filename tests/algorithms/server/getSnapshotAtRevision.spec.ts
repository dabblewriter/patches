    ...
    const mockChanges = [
      {
        ...
        rev: 11,
        baseRev: 10,
        createdAt: '2024-01-01T00:00:01.100Z',
        committedAt: '2024-01-01T00:00:01.100Z',
      ...
      },
      {
        ...
        rev: 12,
        baseRev: 11,
        createdAt: '2024-01-01T00:00:01.200Z',
        committedAt: '2024-01-01T00:00:01.200Z',
  ...
  it('should handle complex scenario with multiple versions', async () => {
    ...
    const mockChanges = [
      ...
      },
      {
        ...
        rev: 18,
        baseRev: 17,
        createdAt: '2024-01-01T00:00:01.300Z',
        committedAt: '2024-01-01T00:00:01.300Z',
