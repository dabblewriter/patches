...
describe('DocManager', () => {
  ...
  describe('openDoc', () => {
    ...
    it('should not increment ref count on failed open', async () => {
      ...
      const badPatches = new Patches({ store: new InMemoryStore() });
  ...
  describe('getDocManager', () => {
    ...
    it('should return different managers for different Patches instances', () => {
      const patches1 = new Patches({ store: new InMemoryStore() });
      const patches2 = new Patches({ store: new InMemoryStore() });
